...
import 'inscription_association_model.dart';
export 'inscription_association_model.dart';

class InscriptionAssociationWidget extends StatefulWidget {
  const InscriptionAssociationWidget({super.key});

  @override
  State<InscriptionAssociationWidget> createState() =>
      _InscriptionAssociationWidgetState();
}

class _InscriptionAssociationWidgetState
    extends State<InscriptionAssociationWidget> {
  late InscriptionAssociationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InscriptionAssociationModel());
