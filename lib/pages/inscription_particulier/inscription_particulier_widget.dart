...
import 'inscription_particulier_model.dart';
export 'inscription_particulier_model.dart';

class InscriptionParticulierWidget extends StatefulWidget {
  const InscriptionParticulierWidget({super.key});

  @override
  State<InscriptionParticulierWidget> createState() =>
      _InscriptionParticulierWidgetState();
}

class _InscriptionParticulierWidgetState
    extends State<InscriptionParticulierWidget> {
  late InscriptionParticulierModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InscriptionParticulierModel());
