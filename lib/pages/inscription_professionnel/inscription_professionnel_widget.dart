...
import 'inscription_professionnel_model.dart';
export 'inscription_professionnel_model.dart';

class InscriptionProfessionnelWidget extends StatefulWidget {
  const InscriptionProfessionnelWidget({super.key});

  @override
  State<InscriptionProfessionnelWidget> createState() =>
      _InscriptionProfessionnelWidgetState();
}

class _InscriptionProfessionnelWidgetState
    extends State<InscriptionProfessionnelWidget> {
  late InscriptionProfessionnelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InscriptionProfessionnelModel());
                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: FlutterFlowRadioButton(
                          options: ['Monsieur', 'Madame'].toList(),
